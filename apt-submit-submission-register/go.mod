...
require (
	...
	github.com/uvalib/aptrust-submit-db-dao/uvaaptsdao v0.0.0-20260319183751-3c5b56ee85eb
)
...
require (
	...
	github.com/uvalib/aptrust-submit-bus-definitions/uvaaptsbus v0.0.0-20260316181657-60b3597dab4a // indirect
)
